        ...
        <Card className="mt-6">
          <div className="grid gap-4">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <a href="https://www.instagram.com/sethlum/" target="_blank" rel="noreferrer"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-[color:var(--accent)] px-5 py-2.5 text-sm font-medium text-white transition hover:opacity-90">
              ...
              <a href="https://t.me/fwast" target="_blank" rel="noreferrer"
                className="inline-flex items-center justify-center gap-2 rounded-full border border-[color:var(--border)] bg-[color:var(--surface)] px-5 py-2.5 text-sm font-medium text-[color:var(--text)] transition hover:opacity-80">
