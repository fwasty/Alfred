...
const urls = [
  // Reselling / multi-niche hustles
  'https://whop.com/discover/polarchefs/',
  'https://whop.com/discover/vookum/',

  // Trading tools
  'https://whop.com/discover/risological-buy-sell-trading-signals-indicator/',

  // AI / creator economy
  'https://whop.com/discover/ai-academy-365/',
  'https://whop.com/discover/voiceaibootcamp/',
  'https://whop.com/discover/aivideocreationbootcamp/',
];
