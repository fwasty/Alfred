...
// New (not-yet-seeded) Whop pages confirmed via direct fetch.
const seeds = [
  {
    handle: 'studydropshipping',
    name: 'Study Dropshipping',
    category: 'Ecom',
    whop_url: 'https://whop.com/discover/studydropshipping/study-dropshipping-free-course/',
  },
  {
    handle: 'new-1on1-mentorship',
    name: 'New 1on1 Mentorship',
    category: 'Ecom',
    whop_url: 'https://whop.com/discover/new-1on1-mentorship/wlp-a-z-organic-dropshipping-course-51/',
  },
];
