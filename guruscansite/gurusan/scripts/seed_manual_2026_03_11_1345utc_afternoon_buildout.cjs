...
// Notes:
// - Prefer /discover/<company>/ URLs when possible.
// - Skip low-confidence/odd pages.
const urls = [
  // Trading
  'https://whop.com/discover/snipex/free-signals-discord-only/',
  'https://whop.com/discover/ciphertrades-live-access/ciphertrades-community/',

  // Agency / AI
  'https://whop.com/discover/waam/waam/',
  'https://whop.com/discover/aimasteryalliance/',
