...
const seeds = [
  // Trading
  { handle: 'ceo-club-discord', name: 'CEO Club — Mentorship', category: 'Trading', whop_url: 'https://whop.com/discover/ceo-club-discord/mentorship-2b/' },
  { handle: 'masterdaytrading', name: 'Master Day Trading Mentorship', category: 'Trading', whop_url: 'https://whop.com/discover/masterdaytrading/masterdaytrading-mentorship-program/' },
  { handle: 'her-trading-mentorship', name: 'Her Trading VIP Chat', category: 'Trading', whop_url: 'https://whop.com/discover/her-trading-mentorship/her-trading-mentorship/' },

  // Clipping / content rewards
  { handle: 'fam-42', name: 'fam Properties', category: 'Clipping', whop_url: 'https://whop.com/discover/fam-42/fam-properties/' },
];
