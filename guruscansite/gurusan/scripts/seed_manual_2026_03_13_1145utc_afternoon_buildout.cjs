...
const seeds = [
  // Trading
  { handle: 'masterthemarket', name: 'Mastering Market Mentorship', category: 'Trading', whop_url: 'https://whop.com/discover/masterthemarket/mastering-market-mentorships/' },
  ...
  { handle: 'alexgtradesllc', name: 'Alex G Trades — Mentorship', category: 'Trading', whop_url: 'https://whop.com/discover/alexgtradesllc/mentorship-81-86d5/' },
  { handle: 'powertrade', name: 'PowerTrade — Mentorship', category: 'Trading', whop_url: 'https://whop.com/discover/powertrade/mentorshipss/' },
  { handle: 'discord-0dte-spx-alerts', name: '0DTE SPX Alerts', category: 'Trading', whop_url: 'https://whop.com/discover/discord-0dte-spx-alerts/' },
];
