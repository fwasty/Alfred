...
// 2026-03-11 batch
// Budget guidance: keep web_search small + conservative; only high-confidence matches.
// Sources used (high confidence):
// - Prior internal batch notes (2026-03-10): Divine (Casey Woodward), KingCap702, Hold My Hand Wholesale (Richard Taylor), Beat The Books, Pro Sports Advice, Profit Lounge.
// - Whop blog: "How Tyson Nguyen turned his hobby into a full time job..." (SecuredPicks).
// - Public socials discovered via web_search results: IG @securedtys + X @securedpicks.
...
const enrichments = [
  ...
  },
  {
    creator: {
      ...
      bio: 'Founder/CEO behind SecuredPicks (sports betting community on Whop).',
    ...
    aliases: ['securedpicks', 'secured picks', 'tyson nguyen', 'securedtys', '@securedpicks', '@securedtys'],
