...
// Manual seed adds for 2026-03-10 11:45 UTC (afternoon build-out)
// High-confidence Whop company pages where root /<slug>/ resolves to /joined/<slug>/.
const seeds = [
  { handle: 'trader-beast', name: 'Trader Beast', category: 'Trading', whop_url: 'https://whop.com/trader-beast/' },
  { handle: 'inf-trade', name: 'INF Trade', category: 'Trading', whop_url: 'https://whop.com/inf-trade/' },
  { handle: 'cryptoholic', name: 'Cryptoholic', category: 'Trading', whop_url: 'https://whop.com/cryptoholic/' },
  { handle: 'the-ecom-palace', name: 'The Ecom Palace Product Drops', category: 'Ecom', whop_url: 'https://whop.com/the-ecom-palace/' },
];
