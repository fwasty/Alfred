...
const urls = [
  // Trading
  'https://whop.com/discover/tradethrive/',
  'https://whop.com/discover/premium-signals/',

  // Agency
  'https://whop.com/discover/algorithm-accelerator/',
  'https://whop.com/discover/oac-agency-accelerator/',

  // Ecom / Dropshipping
  'https://whop.com/discover/studydropshipping/',
  'https://whop.com/discover/studydropshippingplus/',
  'https://whop.com/discover/only-dropshipping/',
];
