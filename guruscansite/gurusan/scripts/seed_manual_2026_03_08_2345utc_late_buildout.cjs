...
// Sources (Mar 8 2026): Brave search results for popular trading + agency communities on Whop.
// Goal: add high-confidence brands/communities, then sync via /api/whop/sync to ingest offers + socials.
const urls = [
  // Futures / trading
  'https://whop.com/discover/level-up-trading-community/',
  'https://whop.com/discover/olympustrading/',
  'https://whop.com/discover/e-mini-maverick/',
  'https://whop.com/discover/traders-alchemy/',
  'https://whop.com/discover/fwa-trading/',

  // Agencies / business communities
  'https://whop.com/discover/agencysecrets/',
  'https://whop.com/discover/agency-blueprint/',
  'https://whop.com/discover/the-agency-engine/',
  'https://whop.com/discover/agency-network/',
];
